...
Tags: youtube, youtube playlists, subscription, subscribe, embed, video, videos, play, live, player, playlist, youtube plugin, youtube player, youtube gallery, custom, channel, youtube channel, search, ratings, views, likes, dislikes, google, api, free, youtube playlist, curate, create, list, audio, podcast, podcasts, svg, responsive, mobile, music, movies, movie, songs, tutorials
...
* Uploads. (Can be hidden)
* Playlists (lists videos on that playlist on click). (Can be hidden)
